...
| S3-004 | Product search functionality | Search bar on product list page queries product name, description, and producer name (case-insensitive, partial matches). Empty results show a friendly message. Search combines with existing category and organic filters. | TC-005 | High | Gia Ngo | 3h | To Do |
